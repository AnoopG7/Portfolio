  ...
  return (
    <div ref={containerRef} id="contact" style={{ height: "300vh" }}>
      <div ref={viewportRef} className="h-screen w-full relative overflow-hidden">
        ...
        <div data-pin-content className="max-w-3xl mx-auto px-6 md:px-10 text-center relative z-10 w-full pt-32">
          {/* Section header */}
          ...
          <div className="flex flex-col sm:flex-row items-stretch justify-center gap-4 mb-14">
            <Card data-pin-item className="flex-1 border-border bg-card/60 hover:border-accent/30 transition-all duration-300 py-0 group">
          ...
          {/* Social Icons */}
          <div data-pin-item className="flex items-center justify-center gap-3">
            <Button
              asChild
              variant="outline"
              size="icon"
