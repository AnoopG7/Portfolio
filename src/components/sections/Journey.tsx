...
export default function Journey() {
  ...
  return (
    <section ref={sectionRef} id="journey" className="relative py-16 sm:py-24 md:py-32">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 md:px-10 w-full">
        ...
        <h2 data-reveal className="font-display text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight mb-10 sm:mb-16">
          My Journey
        </h2>
        ...
        <div className="relative">
          ...
          <div className="space-y-10">
            {JOURNEY.map((milestone, i) => {
              ...
              return (
                <div key={i} data-reveal className="relative pl-8 sm:pl-10 md:pl-14 group">
                  <div
                    className={`absolute left-0 md:left-1 top-1.5 size-3 sm:size-[15px] rounded-full border-2 transition-all duration-300 ${
                      isLast
                        ? "border-accent bg-accent/20 shadow-[0_0_12px_rgba(217,126,22,0.4)]"
                  ...
                  <div className="group-hover:translate-x-1 transition-transform duration-300">
                    ...
                    <h3 className="font-display text-lg sm:text-xl md:text-2xl font-bold mt-1.5 mb-2 text-foreground group-hover:text-accent transition-colors duration-300">
                      {milestone.title}
                    </h3>
